    ...
    if (!window.__psrNewsResourcesClickHandler) {
        ...
        document.addEventListener(
            ...
            function(e) {
                ...
                window.openResourcesAndScrollWhatNew();
            },
            true
        );
    }
			...
			<div class="psr-carousel-main">
				...
				<div class="psr-carousel-viewport">
					<div class="psr-carousel-track">
						...
						<div class="psr-carousel-slide"><img src="https://raw.githubusercontent.com/AnujSharma2008/psr/refs/heads/main/assets/misc/update3.png" alt="Remastered Update Step 3"></div>
					</div>
				</div>
